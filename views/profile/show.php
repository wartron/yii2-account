...
$this->title = empty($profile->name) ? Html::encode($profile->account->username) : Html::encode($profile->name);
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-8">
                ...
                <ul style="padding: 0; list-style: none outside none;">
                    ...
                    <?php endif; ?>
                    <li><i class="glyphicon glyphicon-time text-muted"></i> <?= Yii::t('account', 'Joined on {0, date}', $profile->account->created_at) ?></li>
                </ul>
